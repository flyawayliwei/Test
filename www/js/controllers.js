angular.module('starter.controllers', ['starter.factories', 'starter.services', 'starter.services1', 'starter.filters' ])

    .controller('AppCtrl', function(Tabs,$scope, $location, $ionicModal, $ionicPopup, CacheFactory, SettingFactory, HttpFactory){
         ...
         * 发布话题 modal
         */
        $ionicModal.fromTemplateUrl('View/new_topic.html', {
            scope: $scope
        }).then(function(modal){
    ...
    // 主题首页
    .controller('TopicsCtrl', function($scope, HttpFactory, CacheFactory, $ionicModal){
    ...
    .controller('TopicCtrl', function($scope, $stateParams, $ionicModal, $ionicPopup, HttpFactory, ImageService){
         ...
         * 评论
         */
        $ionicModal.fromTemplateUrl('View/new_replie.html', {
            scope: $scope
        }).then(function(modal){
